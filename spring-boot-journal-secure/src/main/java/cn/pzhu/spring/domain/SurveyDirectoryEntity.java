...
public class SurveyDirectoryEntity extends IdEntity{
    ...
    private SurveyDirectoryEntity surveyDetail=null;
    @Transient
    public SurveyDirectoryEntity getSurveyDetail() {
        return surveyDetail;
    }

    public void setSurveyDetail(SurveyDirectoryEntity surveyDetail) {
