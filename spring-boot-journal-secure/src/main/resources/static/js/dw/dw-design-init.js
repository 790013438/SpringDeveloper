/**
 *
 * DWSurvey 3.0 中关于试卷设计Javascript
 *
 * @desc: design survey
...
$(document).ready(function () {
    ...
    ueDialog = $("#dialog").dialog({
        ...
        hide: {
            effect: "blind", direction: "left", duration: 200,
    ...
    $(".dwQuDialogAddLogic").click(function () {
        addQuDialogLogicTr(true, function () {
        }, function () {
            alert("此题已经设置了任意选项!");
        });
        return false;
