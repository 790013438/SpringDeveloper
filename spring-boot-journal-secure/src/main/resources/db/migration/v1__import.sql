...
CREATE TABLE `account` (`ACCOUNT_NAME` VARCHAR(255) NOT NULL, `PASSWORD` VARCHAR(255) NOT NULL, `ID` SERIAL, `ENABLED` BOOL DEFAULT true, `LAST_MODIFIED_DATE` DATE, `CREATED_DATE` DATE);
